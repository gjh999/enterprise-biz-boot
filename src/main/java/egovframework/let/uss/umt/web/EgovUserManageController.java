...
public class EgovUserManageController {
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = {"/uss/umt/user/EgovIdDplctCnfirmView.do", "/uss/umt/cmm/EgovIdDplctCnfirmView.do"})
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = "/uss/umt/user/EgovIdDplctCnfirm.do")
	public String checkIdDplct(@RequestParam Map<String, Object> commandMap, Model model) throws Exception {
		...
		if (checkId == null || checkId.equals(""))
			return "forward:/uss/umt/user/EgovIdDplctCnfirmView.do";
