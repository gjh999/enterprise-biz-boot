...
CREATE TABLE TB_CONECT_LOG (
  LOG_ID decimal(20,0) NOT NULL DEFAULT '0',
  SRVC_NM varchar(60) DEFAULT NULL,
  METHOD_NM varchar(60) DEFAULT NULL,
  OCCRRNC_DE char(8) DEFAULT NULL,
  CREAT_CO decimal(10,0) DEFAULT '0',
  UPDT_CO decimal(10,0) DEFAULT '0',
  RDCNT decimal(10,0) DEFAULT '0',
  DELETE_CO decimal(10,0) DEFAULT '0',
  OUTPT_CO decimal(10,0) DEFAULT '0',
  ERROR_CO decimal(10,0) DEFAULT '0',
  CONECT_ID varchar(20) DEFAULT NULL,
  CONECT_IP varchar(23) DEFAULT NULL,
  CONECT_MTHD char(1) DEFAULT NULL,
  ERROR_OCCRRNC_AT char(1) DEFAULT NULL,
