...
CREATE TABLE TB_ENTRPRS_MBER (
  ...
  TELNO varchar(20) DEFAULT NULL,  -- 전화번호
  ESNTL_ID char(20) NOT NULL,  -- 고유ID
...
CREATE TABLE TB_SYS_LOG_SUMMARY (
  ...
  CREAT_CO decimal(10,0) DEFAULT NULL,  -- 생성수
  UPDT_CO decimal(10,0) DEFAULT NULL,  -- 갱신수
  RDCNT decimal(10,0) DEFAULT NULL,  -- 조회수
  DELETE_CO decimal(10,0) DEFAULT NULL,  -- 삭제수
  OUTPT_CO decimal(10,0) DEFAULT NULL,  -- OUTPT수
  ERROR_CO decimal(10,0) DEFAULT NULL,  -- 오류수
