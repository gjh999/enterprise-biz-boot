...
-- ============================================================
ALTER TABLE TB_BANNER ADD (BANNER_TY VARCHAR2(10) DEFAULT 'MAIN', POPUP_LEFT NUMBER(10), POPUP_TOP NUMBER(10), POPUP_WIDTH NUMBER(10), POPUP_HEIGHT NUMBER(10), POPUP_GROUP_AT CHAR(1) DEFAULT 'N', EXPSR_BGNDE DATE, EXPSR_ENDDE DATE);
ALTER TABLE TB_STPLAT_INFO ADD (VER VARCHAR2(20), APLC_DE VARCHAR2(8), REPRSNT_AT CHAR(1) DEFAULT 'N', USE_AT CHAR(1) DEFAULT 'Y');
ALTER TABLE TB_INDVDL_INFO_POLICY ADD (VER VARCHAR2(20), APLC_DE VARCHAR2(8), REPRSNT_AT CHAR(1) DEFAULT 'N', USE_AT CHAR(1) DEFAULT 'Y');
