...
CREATE TABLE TB_SYS_LOG_SUMMARY (
  ...
  CREAT_CO NUMERIC(10) DEFAULT NULL,  -- 생성수
  UPDT_CO NUMERIC(10) DEFAULT NULL,  -- 갱신수
  RDCNT NUMERIC(10) DEFAULT NULL,  -- 조회수
  DELETE_CO NUMERIC(10) DEFAULT NULL,  -- 삭제수
  OUTPT_CO NUMERIC(10) DEFAULT NULL,  -- OUTPT수
  ERROR_CO NUMERIC(10) DEFAULT NULL,  -- 오류수
  PRIMARY KEY (OCCRRNC_DE,SVC_NM,METHOD_NM)
);

CREATE TABLE TB_CONECT_LOG (
  LOG_ID NUMERIC(20) DEFAULT 0 NOT NULL,  -- 로그ID
  SRVC_NM VARCHAR(60) DEFAULT NULL,  -- 서비스명
  METHOD_NM VARCHAR(60) DEFAULT NULL,  -- METHOD명
  OCCRRNC_DE CHAR(8) DEFAULT NULL,  -- 발생일자
  CREAT_CO NUMERIC(10) DEFAULT 0,  -- 생성수
  UPDT_CO NUMERIC(10) DEFAULT 0,  -- 갱신수
  RDCNT NUMERIC(10) DEFAULT 0,  -- 조회수
  DELETE_CO NUMERIC(10) DEFAULT 0,  -- 삭제수
  OUTPT_CO NUMERIC(10) DEFAULT 0,  -- OUTPT수
  ERROR_CO NUMERIC(10) DEFAULT 0,  -- 오류수
  CONECT_ID VARCHAR(20) DEFAULT NULL,  -- 접속ID
  CONECT_IP VARCHAR(23) DEFAULT NULL,  -- 접속IP
  CONECT_MTHD CHAR(1) DEFAULT NULL,  -- 접속방식
  ERROR_OCCRRNC_AT CHAR(1) DEFAULT NULL,  -- 오류발생여부
