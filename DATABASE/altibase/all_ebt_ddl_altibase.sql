...
CREATE TABLE TB_CONECT_LOG  (
  LOG_ID number(20,0) DEFAULT 0 NOT NULL ,
  SRVC_NM varchar2(60) ,
  METHOD_NM varchar2(60) ,
  OCCRRNC_DE char(8) ,
  CREAT_CO number(10,0) DEFAULT 0 ,
  UPDT_CO number(10,0) DEFAULT 0 ,
  RDCNT number(10,0) DEFAULT 0 ,
  DELETE_CO number(10,0) DEFAULT 0 ,
  OUTPT_CO number(10,0) DEFAULT 0 ,
  ERROR_CO number(10,0) DEFAULT 0 ,
  CONECT_ID varchar2(20) ,
  CONECT_IP varchar2(23) ,
  CONECT_MTHD char(1) ,
  ERROR_OCCRRNC_AT char(1) ,
...
CREATE TABLE TB_USER_ABSNCE  (
  EMPLYR_ID varchar2(20) NOT NULL ,
  USER_ABSNCE_AT char(1) DEFAULT 'N' ,
  FRST_REGIST_PNTTM DATE ,
  FRST_REGISTER_ID varchar2(20) ,
  LAST_UPDT_PNTTM DATE ,
  LAST_UPDUSR_ID varchar2(20) ,
...
CREATE TABLE TB_PROGRM_CHANGE_DTLS (
  PROGRM_FILE_NM     VARCHAR2(180) NOT NULL,
  REQUST_NO          NUMBER(10)    DEFAULT 0 NOT NULL,
  PROGRM_KOREAN_NM   VARCHAR2(60),
  RQESTER_ID         VARCHAR2(20),
  CHANGE_REQUST_CN   VARCHAR2(2500),
  REQUST_PROCESS_CN  VARCHAR2(2500),
  OPETR_ID           VARCHAR2(20),
  PROCESS_STTUS_CODE VARCHAR2(15),
  PROCESS_DE         VARCHAR2(20),
  REQUST_DE          VARCHAR2(20),
  REQUST_SJ          VARCHAR2(100),
