...
CREATE TABLE TB_SYS_LOG_SUMMARY  (
  ...
  SVC_NM varchar2(200) NOT NULL,  -- 봉사명
  METHOD_NM varchar2(60) NOT NULL,  -- METHOD명
  CREAT_CO number(10,0),  -- 생성수
  UPDT_CO number(10,0),  -- 갱신수
  RDCNT number(10,0),  -- 조회수
  DELETE_CO number(10,0),  -- 삭제수
  OUTPT_CO number(10,0),  -- OUTPT수
  ERROR_CO number(10,0),  -- 오류수
